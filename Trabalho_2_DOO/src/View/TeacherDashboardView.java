...
public class TeacherDashboardView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        prctOfFailureLabel = new javax.swing.JLabel();
        ...
        prctOfFailureLabel.setFont(new java.awt.Font("Arial", 0, 52)); // NOI18N
        prctOfFailureLabel.setForeground(new java.awt.Color(42, 8, 69));
        prctOfFailureLabel.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        prctOfFailureLabel.setText("0.0%");
        ...
        statisticPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, statisticPanel3Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(prctOfFailureLabel)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void startDashBoardInfo(ClassModel classToChange) {
        if (classToChange != null) {
            ...
            prctOfFailureLabel.setText(Main.controller.getPrctOfFailure(classToChange));
        }
    }
    ...
    private javax.swing.JLabel prctOfFailureLabel;
